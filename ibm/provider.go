...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_cloudant_service_instance":        resourceIBMServiceInstance(),
			"ibm_cloudant_service_key":             resourceIBMServiceKey(),
			"ibm_wds_service_instance":             resourceIBMServiceInstance(),
			"ibm_wds_service_key":                  resourceIBMServiceKey(),
			"ibm_cos_service_instance":             resourceIBMServiceInstance(),
